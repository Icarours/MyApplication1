...
import com.syl.myapplication1.domain.CardBean;
import com.syl.myapplication1.domain.ProvinceBean;
import com.syl.myapplication1.pick_view.FragmentTestActivity;
import com.syl.myapplication1.pick_view.JsonDataActivity;
 ...
 * 直接复制粘贴的别人demo中的代码
 */
public class PickViewActivity extends AppCompatActivity implements View.OnClickListener{
...
//等数据加载完毕再初始化并显示Picker,以免还未加载完数据就显示,造成APP崩溃。
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_Time && pvTime != null) {
            ...
            startActivity(new Intent(PickViewActivity.this, JsonDataActivity.class));
        } else if (v.getId() == R.id.btn_fragment) {//跳转到 fragment
            startActivity(new Intent(PickViewActivity.this, FragmentTestActivity.class));
    ...
    private void initLunarPicker() {
        ...
        pvCustomLunar = new TimePickerBuilder(this, new OnTimeSelectListener() {
            ...
            public void onTimeSelect(Date date, View v) {//选中事件回调
                Toast.makeText(PickViewActivity.this, getTime(date), Toast.LENGTH_SHORT).show();
            }
        })
            ...
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                ...
                .setOptionsSelectChangeListener(new OnOptionsSelectChangeListener() {
                    ...
                    public void onOptionsSelectChanged(int options1, int options2, int options3) {
                        ...
                        Toast.makeText(PickViewActivity.this, str, Toast.LENGTH_SHORT).show();
                    }
                })
                .build();
