package com.syl.googleplay3.view.flyinout;
...
public class StellarMap extends FrameLayout implements AnimationListener, OnTouchListener, OnGestureListener {
	...
	public static interface Adapter {
		public abstract int getGroupCount();//多少组

		public abstract int getCount(int group);//每组多少个

		public abstract View getView(int group, int position, View convertView);//每个空间的样子
