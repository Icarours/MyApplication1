...
import com.syl.coolwater.utils.Utils;
...
public class GaodeFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_gaode, null);
        ButterKnife.bind(this, rootView);
        mTvContent.setMovementMethod(ScrollingMovementMethod.getInstance());
        mTvContent.setText("高德地图定位");
    ...
    AMapLocationListener locationListener = new AMapLocationListener() {
        ...
        public void onLocationChanged(AMapLocation location) {
            if (null != location) {
                ...
                mTvContent.setText("定位失败，loc is null");
            }
        }
    };
    /**
